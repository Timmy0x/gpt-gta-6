...
const bbox=preparation.bboxWgs84 as number[],corners=[[bbox[0],bbox[1]],[bbox[2],bbox[1]],[bbox[2],bbox[3]],[bbox[0],bbox[3]]].map(([lon,lat])=>projectMiami(lon,lat));
