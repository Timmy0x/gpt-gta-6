...
## Interaction checkpoint (9 September 2026)

Fire and aim now turn the body before shots are allowed; the arms do not twist backward to follow a camera behind the character. Serious nonfatal injuries remain incapacitated instead of recovering in seconds, including save/load. Civilian traffic carries visible drivers, with a timed driver-removal and seat handoff that preserves the same fleeing NPC. Driving remains locked during entry and exit even with W held. Persistent controls text is reduced.
