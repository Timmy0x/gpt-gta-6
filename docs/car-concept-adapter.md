# Car Concept: prepared asset and future runtime adapter

The debranded asset is ready at `public/vehicles/concept/car.glb`; it is **not yet a drivable runtime model**. The GLB contains a detailed cabin, separate doors, hood, rear hatch, wheels, brakes and lights. It is a concept-car asset rather than a GTA VI vehicle replica.
